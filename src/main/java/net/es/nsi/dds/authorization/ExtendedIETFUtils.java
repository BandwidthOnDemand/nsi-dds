...
public class ExtendedIETFUtils
{
    ...
    public static RDN[] rDNsFromString(String name, X500NameStyle x500Style)
    {
        ...
        while (nTok.hasMoreTokens())
        {
            ...
            if (token.indexOf('+') > 0)
            {
                ...
                {
                    ArrayList<ASN1ObjectIdentifier> oids = new ArrayList<>();
    ...
    private static String[] toValueArray(ArrayList<String> values)
    {
    ...
    private static ASN1ObjectIdentifier[] toOIDArray(ArrayList<ASN1ObjectIdentifier> oids)
    {
    ...
    public static String[] findAttrNamesForOID(
        ...
        Map<String, ASN1ObjectIdentifier> lookup)
    {
        int count = 0;
        for (ASN1ObjectIdentifier currOID : lookup.values())
        {
            if (oid.equals(currOID))
            {
                count++;
            }
        }
    ...
    private static boolean atvAreEqual(AttributeTypeAndValue atv1, AttributeTypeAndValue atv2)
    {
        ...
        String v1 = ExtendedIETFUtils.canonicalize(ExtendedIETFUtils.valueToString(atv1.getValue()));
        String v2 = ExtendedIETFUtils.canonicalize(ExtendedIETFUtils.valueToString(atv2.getValue()));
